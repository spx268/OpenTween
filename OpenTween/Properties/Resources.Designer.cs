...
namespace OpenTween.Properties {
    ...
    internal class Resources {
        ...
        /// * ベータ版です
        /// * 使用中に不具合が起きた場合は #OpenTween かメールで遠慮なく報告して下さい
        ///
        ...
        /// * FIX: 96dpiの環境で発言詳細欄のアイコンが等倍に表示されるようにサイズ調整 (thx @5px!)
        /// * FIX: サムネイル表示の2枚目以降の画像が正しいサイズで表示されない不具合を修正
        /// * FIX: 発言詳細欄に表示したツイートに含まれるURLへ無差別にHEADリクエストを飛ばす問題を修正
        /// * FIX: 言語設定が英語の状態でコンテキストメニュー [残りの文字列は切り詰められました]&quot;; に類似しているローカライズされた文字列を検索します。
        /// </summary>
